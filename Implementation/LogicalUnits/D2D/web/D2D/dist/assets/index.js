...
function requireClient() {
  ...
  if (true) {
    ...
    assets_exports.createRoot = function(c, o) {
    ...
    assets_exports.hydrateRoot = function(c, h, o) {
      i.usingClientEntryPoint = true;
      try {
...
const ReactDOM = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: index
}, Symbol.toStringTag, { value: "Module" }));
/**
...
function D2DProcessUI() {
  const defaultParams = {
    d2dMode: "legacy",
    D2D_SOURCE_ENV: "",
    D2D_TARGET_ENV: "",
    D2D_FABRIC_INTERFACE_SRC: "",
    D2D_FABRIC_INTERFACE_TAR: "",
    D2D_F2F_SCHEMA_SRC: "",
    D2D_F2F_SCHEMA_TAR: "",
    EXECUTION_ID: "",
    executionMode: "single",
    entityList: "",
    pringSummaryReport: true,
    luType: "",
    IGNOREMATCH: false,
    batchInterface: "",
    D2D_TABLE_DISCOVERY_STRATEGY: "MTable",
    batchSql: ""
  };
  const d2dModes = [{
    value: "legacy",
    label: "Dedicated D2D LU (Legacy)"
  }, {
    value: "fabric_to_fabric",
    label: "D2D for Existing LU (Fabric to Fabric)"
  }, {
    value: "table_level",
    label: "D2D for Table Level (Common or Lookup)"
  }, {
    value: "tdm_extract",
    label: "D2D for Existing TDM LU - Extract Mode"
  }, {
    value: "tdm_direct",
    label: "D2D for Existing TDM LU – Direct Mode"
  }];
  const [params, setParams] = reactExports.useState(defaultParams);
  const [encodedCommand, setEncodedCommand] = reactExports.useState(null);
  const [interfaceData, setInterfaceData] = reactExports.useState([]);
  const [environmentData, setEnvironmentData] = reactExports.useState([]);
  const [luData, setLuData] = reactExports.useState([]);
  const [runStatus, setRunStatus] = reactExports.useState(false);
  const {
    fetchData: fetchInterfaceData,
    loading: interfaceLoading,
    error: interfaceError
  } = useFetchData("/api/fabric-command?command=list%20interfaces%3B");
  const {
    fetchData: fetchEnvironmentData,
    loading: environmentLoading,
    error: environmentError
  } = useFetchData("/api/fabric-command?command=list%20envs%3B");
  const {
    fetchData: fetchLuData,
    loading: luLoading,
    error: luError
  } = useFetchData("/api/fabric-command?command=list%20lut%3B");
  const {
    data: schemaSrcData
  } = useFetchData(params.D2D_FABRIC_INTERFACE_SRC ? `/api/d2d/get-schema?interfaceName=${encodeURIComponent(params.D2D_FABRIC_INTERFACE_SRC)}` : null);
  const {
    data: schemaTarData
  } = useFetchData(params.D2D_FABRIC_INTERFACE_TAR ? `/api/d2d/get-schema?interfaceName=${encodeURIComponent(params.D2D_FABRIC_INTERFACE_TAR)}` : null);
  reactExports.useEffect(() => {
    const savedParams = JSON.parse(localStorage.getItem("d2dProcessParams"));
    if (savedParams) {
      setParams((prev) => ({
        ...prev,
        ...savedParams
  ...
  reactExports.useEffect(() => {
    ;
    (async () => {
      const resInterfaceData = await fetchInterfaceData();
      setInterfaceData(resInterfaceData);
    })();
  }, [fetchInterfaceData]);
  reactExports.useEffect(() => {
    ;
    (async () => {
      const resEnvironmentData = await fetchEnvironmentData();
      setEnvironmentData(resEnvironmentData);
    })();
  }, [fetchEnvironmentData]);
  reactExports.useEffect(() => {
    ;
    (async () => {
      const resLuData = await fetchLuData();
      setLuData(resLuData);
    })();
  }, [fetchLuData]);
  reactExports.useEffect(() => {
    if (schemaSrcData) {
      setParams((prev) => ({
        ...prev,
        D2D_F2F_SCHEMA_SRC: schemaSrcData
      }));
    }
  }, [schemaSrcData]);
  reactExports.useEffect(() => {
    if (schemaTarData) {
      setParams((prev) => ({
        ...prev,
        D2D_F2F_SCHEMA_TAR: schemaTarData
      }));
    }
  }, [schemaTarData]);
  reactExports.useEffect(() => {
    if (!encodedCommand || !runStatus) return;
    const fetchExecResult = async () => {
      const response = await fetch(`/api/fabric-command?command=${encodedCommand}&allResultSets=false`);
  ...
  reactExports.useEffect(() => {
    localStorage.setItem("d2dProcessParams", JSON.stringify(params));
  }, [params]);
  ...
  function handleReset() {
    ...
    localStorage.removeItem("d2dProcessParams");
  }
  function handleExecution() {
    ...
    const executionModeMap = {
      legacy: "D2D",
      fabric_to_fabric: "F2F",
      table_level: "F2F",
      tdm_extract: "Extract",
      tdm_direct: "Direct"
    };
    commandsArray.push(`set D2D_TABLE_DISCOVERY_STRATEGY="${params.D2D_TABLE_DISCOVERY_STRATEGY}";`);
    commandsArray.push(`set IGNOREMATCH = ${params.IGNOREMATCH};`);
    if (params.d2dMode === "table_level" || params.d2dMode === "fabric_to_fabric") {
      commandsArray.push(`set D2D_F2F_SCHEMA_SRC = "${params.D2D_F2F_SCHEMA_SRC}";`);
      commandsArray.push(`set D2D_F2F_SCHEMA_TAR = "${params.D2D_F2F_SCHEMA_TAR}";`);
    }
    if (params.d2dMode === "tdm_direct" || params.d2dMode === "tdm_extract") {
      commandsArray.push(`set D2D_SOURCE_ENV = "${params.D2D_SOURCE_ENV}";`);
      commandsArray.push(`set D2D_TARGET_ENV = "${params.D2D_TARGET_ENV}";`);
      luType = params.luType;
    }
    if (params.d2dMode === "fabric_to_fabric") {
      commandsArray.push(`set D2D_FABRIC_INTERFACE_SRC = "${params.D2D_FABRIC_INTERFACE_SRC}";`);
      commandsArray.push(`set D2D_FABRIC_INTERFACE_TAR = "${params.D2D_FABRIC_INTERFACE_TAR}";`);
    }
    let bwCommand = `broadway ${luType}.d2dBatchExecute printSummaryReport=${params.pringSummaryReport} execution_mode="${executionModeMap[params.d2dMode]}"`;
    if (params.executionMode === "single") {
      bwCommand += ` entity_list="${params.entityList}";`;
    } else {
      bwCommand += ` interface="${params.batchInterface}" sql="${params.batchSql}";`;
    }
    commandsArray.push(bwCommand);
    const commands = commandsArray.join("\n");
    const encoded = encodeURIComponent(commands);
    setEncodedCommand(encoded);
    console.log("Encoded command:\n", commands);
    setRunStatus(true);
  }
  return /* @__PURE__ */ jsxs("div", {
    className: "flex flex-col justify-start bg-gray-100 p-6 min-h-screen",
    children: [/* @__PURE__ */ jsxs("form", {
      ...
      children: [/* @__PURE__ */ jsx("h1", {
        ...
        children: "Run D2D Process"
      }), /* @__PURE__ */ jsxs("div", {
        className: "bg-blue-50 p-4 rounded-lg mt-4",
        children: [/* @__PURE__ */ jsx("h3", {
          className: "text-lg font-semibold text-gray-700",
          children: "Select D2D Mode"
        }), /* @__PURE__ */ jsx("div", {
          className: "grid grid-cols-2 gap-3 mt-2",
          children: d2dModes.map((mode) => /* @__PURE__ */ jsxs("label", {
            className: "flex items-center space-x-2",
            children: [/* @__PURE__ */ jsx("input", {
              type: "radio",
              name: "d2dMode",
              value: mode.value,
              checked: params.d2dMode === mode.value,
        ...
        children: [(params.d2dMode === "tdm_extract" || params.d2dMode === "tdm_direct") && /* @__PURE__ */ jsxs("div", {
          children: [/* @__PURE__ */ jsxs("label", {
            ...
            children: [/* @__PURE__ */ jsx("option", {
              disabled: true,
              value: "",
              children: "Select source environment"
            }), environmentLoading ? /* @__PURE__ */ jsx("option", {
              children: "Loading..."
            }) : environmentError ? /* @__PURE__ */ jsx("option", {
              children: "Error loading environments"
            }) : environmentData.map((item) => /* @__PURE__ */ jsx("option", {
              value: item.Environments,
              children: item.Environments
            }, item.Environments))]
          })]
        }), params.d2dMode === "fabric_to_fabric" && /* @__PURE__ */ jsxs("div", {
          children: [/* @__PURE__ */ jsxs("label", {
            className: "text-gray-700",
            ...
            name: "D2D_FABRIC_INTERFACE_SRC",
            value: params.D2D_FABRIC_INTERFACE_SRC,
            onChange: handleInputChange,
            className: "w-full mt-1 p-2 border rounded",
            required: true,
            children: [/* @__PURE__ */ jsx("option", {
            ...
            }), interfaceLoading ? /* @__PURE__ */ jsx("option", {
              children: "Loading..."
            }) : interfaceError ? /* @__PURE__ */ jsx("option", {
              children: "Error loading interfaces"
            }) : interfaceData.map((item) => /* @__PURE__ */ jsx("option", {
              disabled: !item.ACTIVE,
              value: item.INTERFACE,
              children: item.INTERFACE + " - " + item.TYPE
            }, item.INTERFACE))]
          })]
        }), (params.d2dMode === "fabric_to_fabric" || params.d2dMode === "table_level") && /* @__PURE__ */ jsxs("div", {
          children: [/* @__PURE__ */ jsxs("label", {
            className: "text-gray-700",
            ...
            type: "text",
            name: "D2D_F2F_SCHEMA_SRC",
            value: params.D2D_F2F_SCHEMA_SRC,
            onChange: handleInputChange,
            className: "w-full mt-1 p-2 border rounded",
            required: true
          })]
        }), (params.d2dMode === "tdm_extract" || params.d2dMode === "tdm_direct") && /* @__PURE__ */ jsxs("div", {
          children: [/* @__PURE__ */ jsxs("label", {
            className: "text-gray-700",
            ...
            children: [/* @__PURE__ */ jsx("option", {
              disabled: true,
              value: "",
              children: "Select target environment"
            }), environmentLoading ? /* @__PURE__ */ jsx("option", {
              children: "Loading..."
            }) : environmentError ? /* @__PURE__ */ jsx("option", {
              children: "Error loading environments"
          ...
          children: [/* @__PURE__ */ jsxs("label", {
            ...
            name: "D2D_FABRIC_INTERFACE_TAR",
            value: params.D2D_FABRIC_INTERFACE_TAR,
            onChange: handleInputChange,
            className: "w-full mt-1 p-2 border rounded",
            required: true,
            children: [/* @__PURE__ */ jsx("option", {
          ...
          children: [/* @__PURE__ */ jsxs("label", {
            ...
            type: "text",
            name: "D2D_F2F_SCHEMA_TAR",
            value: params.D2D_F2F_SCHEMA_TAR,
            onChange: handleInputChange,
            className: "w-full mt-1 p-2 border rounded",
            required: true
          })]
        }), (params.d2dMode === "tdm_direct" || params.d2dMode === "tdm_extract") && /* @__PURE__ */ jsxs("div", {
          children: [/* @__PURE__ */ jsxs("label", {
            className: "text-gray-700",
            children: ["LU", /* @__PURE__ */ jsx("span", {
              className: "text-red-500 ml-1",
              children: "*"
            })]
          }), /* @__PURE__ */ jsxs("select", {
            ...
            children: [/* @__PURE__ */ jsx("option", {
              ...
              children: "Loading..."
            }) : luError ? /* @__PURE__ */ jsx("option", {
              children: "Error loading LUs"
            }) : luData.map((item) => /* @__PURE__ */ jsx("option", {
              value: item.LU_NAME,
              children: item.LU_NAME
            }, item.LU_NAME))]
          })]
        }), (params.d2dMode === "tdm_direct" || params.d2dMode === "tdm_extract") && /* @__PURE__ */ jsx("div", {}), /* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsxs("label", {
            className: "text-gray-700 flex items-center",
            children: [/* @__PURE__ */ jsx("input", {
              type: "checkbox",
              name: "pringSummaryReport",
              checked: params.pringSummaryReport,
              onChange: handleInputChange,
              className: "mr-2"
          ...
          children: [/* @__PURE__ */ jsx("label", {
            ...
            name: "D2D_TABLE_DISCOVERY_STRATEGY",
            value: params.D2D_TABLE_DISCOVERY_STRATEGY,
            onChange: handleInputChange,
            className: "w-full mt-1 p-2 border rounded",
            children: [/* @__PURE__ */ jsx("option", {
              value: "MTable",
        ...
        children: [/* @__PURE__ */ jsx("h3", {
          ...
          children: ["single", "batch"].map((mode) => /* @__PURE__ */ jsxs("label", {
            className: "flex items-center space-x-2",
            children: [/* @__PURE__ */ jsx("input", {
              type: "radio",
              name: "executionMode",
              value: mode,
              checked: params.executionMode === mode,
              onChange: handleInputChange,
              className: "accent-blue-500"
            }), /* @__PURE__ */ jsx("span", {
              className: "text-gray-700",
              children: mode === "single" ? "Entity list" : "Batch mode"
            })]
          }, mode))
        })]
      }), params.executionMode === "batch" && /* @__PURE__ */ jsxs("div", {
        className: "mt-4",
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          children: ["Interface", /* @__PURE__ */ jsx("span", {
            className: "text-red-500 ml-1",
            children: "*"
          })]
        }), /* @__PURE__ */ jsxs("select", {
          name: "batchInterface",
          value: params.batchInterface,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true,
          children: [/* @__PURE__ */ jsx("option", {
        ...
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          children: [params.executionMode === "single" ? "Entity list" : "Enter SQL Query for Batch Mode", /* @__PURE__ */ jsx("span", {
            className: "text-red-500 ml-1",
            children: "*"
          })]
        }), /* @__PURE__ */ jsx("textarea", {
          name: params.executionMode === "single" ? "entityList" : "batchSql",
          value: params.executionMode === "single" ? params.entityList : params.batchSql,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded resize-none h-24",
          placeholder: params.executionMode === "single" ? "Enter entity list (e.g., 12345,45678,7890)" : "Enter SQL Query (e.g., SELECT id FROM users WHERE active=1)",
          required: true
        })]
      }), /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("button", {
          type: "submit",
          disabled: runStatus,
          className: `py-2 px-4 rounded-lg ${runStatus ? "bg-gray-400 text-white cursor-not-allowed" : "bg-blue-600 text-white hover:bg-blue-700"}`,
          children: "Run Process"
        }), /* @__PURE__ */ jsx("button", {
          type: "button",
      ...
      className: "w-full max-w-4xl bg-white shadow-lg rounded-lg p-6 mt-6 min-h-[150px]",
  ...
  return /* @__PURE__ */ jsx("div", {
    ...
    children: /* @__PURE__ */ jsxs(Routes, {
      children: [/* @__PURE__ */ jsx(Route, {
        ...
        path: "/cli-process",
        element: /* @__PURE__ */ jsx(D2DProcessUI, {})
      }), /* @__PURE__ */ jsx(Route, {
        path: "/another",
        element: /* @__PURE__ */ jsx(AnotherComponent, {})
      }), /* @__PURE__ */ jsx(Route, {
        path: "*",
...
ReactDOM$1.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsx(React.StrictMode, {
